...
def eval_rag_chain(my_rag_chain):

    q_a_pairs = [
    {
        "question": "What saving throws is a Ranger proficient in?",
        "options": [
            "A) Intelligence and Wisdom",
            "B) Strength and Dexterity",
            "C) Wisdom and Archery",
            "D) Animal Handling, Athletics, and Insight"
        ],
        "answer": "B) Strength and Dexterity"
    },
    {
        "question": "The Dwarf's Stonecunning feature occurs when you make a ...?",
        "options": [
            "A) Boulder smarts check",
            "B) Initiative roll",
            "C) Charisma check",
            "D) Intelligence (History) check"
        ],
        "answer": "D) Intelligence (History) check"
    },
    {
        "question": "Which creature is a valid option for a Druid's Wild Shape feature?",
        "options": [
            "A) Blink Dog",
